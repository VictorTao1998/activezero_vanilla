...
def train_sample(sample, dispnet_model, dispnet_optimizer, isTrain=True):
    ...
    img_output_reproj = {
        'sim_reprojection': {
            'target': img_L_lcn, 'warped': sim_ir_warped, 'pred_disp': sim_pred_disp, 'mask': sim_ir_reproj_mask
        },
        'real_reprojection': {
            'target': img_real_L_lcn, 'warped': real_ir_warped, 'pred_disp': real_pred_disp, 'mask': real_ir_reproj_mask
        }
    }
